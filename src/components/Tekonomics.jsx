        ...
        <>
            <div className="relative bg-[#0A4740]">
                ...
                <div
                    ...
                    id="Tokenomic">
                    <h3
                        className="text-white font-normal ff-chewy sm:text-[64px] text-[42px] leading-[131%] text-center xl:mb-[150px] lg:mb-[60px] mb-[45px]">Tokenomics</h3>
                        ...
                        <div className="relative xl:max-w-[589.84px] lg:max-w-[515px] sm:max-w-[390px] max-w-[330px]">
                            ...
                            <div
                                ...
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#FBA11D] leading-[119%] lg:text-[32px] text-[23px] font-normal ff-balsamiq">333,333,333</p>
                                    <p className="text-white leading-[138%] font-normal text-[24px] text-right ff-balsamiq">Supply</p>
                                </div>
                            ...
                            <div
                                ...
                                <div className="flex flex-col gap-[5px]">
                                    <p
                                        className="text-[#8EC627] lg:max-w-[217px] max-w-[164px] leading-[119%] lg:text-[32px] text-[23px] font-normal ff-balsamiq">
                            ...
                            <div
                                ...
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#D45B07] max-w-[217px] leading-[119%] text-[32px] font-normal ff-balsamiq">No Tax</p>
                                </div>
                            </div>
                            <div
                                className="md:flex hidden absolute xl:bottom-[-27%] bottom-[-17%] left-[-27%] justify-center items-center gap-[17px]">
                                <div className="flex flex-col gap-[5px]">
                                    <p className="text-[#23AAAC] max-w-[217px] leading-[119%] lg:text-[32px] text-[23px] font-normal ff-balsamiq">95%
                                        Uniswa</p>
                                    <p
                                        className="text-[#23AAAC] max-w-[217px] text-right leading-[119%] lg:text-[32px] text-[23px] font-normal ff-balsamiq">
                                        5% Marketing</p>
                                    <p
                                        className="text-white max-w-[217px] text-right leading-[119%] lg:text-[32px] text-[23px]  font-normal ff-balsamiq">
                                        Allocation</p>
                                </div>
                            ...
                            <div
                                ...
                                <p className="text-[#FB5352] leading-[119%] lg:text-[32px] text-[23px] font-normal ff-balsamiq">No Mint Function</p>
                            </div>
                            <div className="md:hidden flex justify-center items-center mt-12">
                                <div className=" flex flex-col gap-[35px]">
                                    <div className="flex sm:gap-[32px] gap-6">
                                        ...
                                        <div className="flex flex-col gap-[5px]">
                                            <p className="text-[#FBA11D] leading-[119%] sm:text-[32px] text-[20px] font-normal ff-balsamiq">333,333,333
                                            </p>
                                            <p className="text-white leading-[138%] font-normal sm:text-[24px] text-[20px] ff-balsamiq">Supply</p>
                                        </div>
                                    </div>
                                    <div className="flex sm:gap-[32px] gap-6">
                                        <div className="w-[34px] h-[34px] border border-solid border-white rounded-md bg-[#23AAAC]"></div>
                                        <div className="flex flex-col gap-[5px]">
                                            <p className="text-[#23AAAC] leading-[119%] sm:text-[32px] text-[20px] font-normal ff-balsamiq">95% Uniswa, 5%
                                                Marketing</p>
                                            <p className="text-white leading-[138%] sm:text-[32px] text-[20px] font-normal ff-balsamiq">Allocation</p>
                                        </div>
                                    </div>
                                    <div className="flex sm:gap-[32px] gap-6 items-center">
                                        ...
                                        <div className="flex flex-col gap-[5px]">
                                            <p className="text-[#D45B07] leading-[119%] sm:text-[32px] text-[20px] font-normal ff-balsamiq">No Tax</p>
                                        </div>
                                    </div>
                                    <div className="flex sm:gap-[32px] gap-6 items-center">
                                        <div className="w-[34px] h-[34px] border border-solid border-white rounded-md bg-[#FB5352]"></div>
                                        <div className="flex flex-col gap-[5px]">
                                            <p className="text-[#FB5352] leading-[119%] sm:text-[32px] text-[20px] font-normal ff-balsamiq">No Mint
                                                Function</p>
                                        </div>
                                    </div>
                                    <div className="flex sm:gap-[32px] gap-6 items-center">
                                        ...
                                        <div className="flex flex-col gap-[5px]">
                                            <p className="text-[#8EC627] leading-[119%] sm:text-[32px] text-[20px] font-norma ff-balsamiq">Liquidity lock
                                                for 1 year</p>
                                        </div>
                                    </div>
                                </div>
